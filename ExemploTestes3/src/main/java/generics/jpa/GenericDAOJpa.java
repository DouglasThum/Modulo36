...
public class GenericDAOJpa <T extends Persistente, E extends Serializable> implements IGenericDAOJpa<T, E> {
	...
	@Override
	public T cadastrar(T entity) throws TipoChaveNaoEncontradoException, exception.DAOException {
		openConnection();
